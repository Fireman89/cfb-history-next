...
const GameService = {
  createScheduleGame(r: GameResponse, teamId: number) {
    ...
    if (r.points_away == null || r.points_home == null) return null;
    ...
    if (teamId === r.id_home_team) {
      ...
      if (r.points_home > r.points_away) gameStatus = "W";
      else if (r.points_home < r.points_away) gameStatus = "L";
      ...
      gameResp.forEach((g) => {
        ...
        for (let i = 0; i < schedules.length; i++) {
          ...
          if (teamId == g.id_home_team || teamId == g.id_away_team) {
            ...
            if (teamId == g.id_home_team) homeFound = true;
            if (teamId == g.id_away_team) awayFound = true;
          }
